		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori app with XSUAA",
									"targetURL": "#nsmta04mta04-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsmta04mta04-display": {
								"semanticObject": "nsmta04mta04",
								"action": "display",
								"description": "Fiori app with XSUAA",
								"title": "Fiori app with XSUAA",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.mta04.mta04",
									"url": sap.ui.require.toUrl("ns/mta04/mta04")
								}
							}
						}
					}
